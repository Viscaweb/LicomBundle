...
class DebugSlugCountryController extends Controller
{
    ...
    public function testSlugMatchersAction()
    {
        ...
        $f1 =  $e->getParticipantCombination('barcelona-real-madrid');
        $f2 =  $e->getParticipantCombination('barcelona-espanyol');
        $f3 =  $e->getParticipantCombination('espanyol-barcelona');
        $v = 1;
        /*
         * Prepare the objects
         */
